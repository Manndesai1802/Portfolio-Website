        ...
        <div className="max-w-4xl mx-auto">
          {experiences.map((exp, index) => (
            ...
            >
              ...
              {/* Content Card */}
              <div className="ml-20 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div className="p-8">
                  <div className="flex flex-wrap items-start justify-between mb-4">
                    ...
                    <span className="bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-300 px-3 py-1 rounded-full text-sm font-medium">
                      {exp.status}
                    </span>
                  </div>
